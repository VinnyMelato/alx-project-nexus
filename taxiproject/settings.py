...
ALLOWED_HOSTS = ['gauteng-taxi-app.onrender.com', 'taxiride.co.za', 'www.taxiride.co.za', 'localhost',]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Leave this empty for now
        'APP_DIRS': True,  # This enables template loading from app folders
        'OPTIONS': {
            'context_processors': [
